...
思考问题：操作系统是软件资源还是硬件资源呢？答：操作系统也是一个特殊的软件资源！！！
...
![image-20220331144352278](media/image-20220331144352278.png)
...
在生产环境中，我们⼀般不会选择最新版本的Python，因为可能会存在未知Bug，所以⼀般强烈建议大家在选择软件版本时，向前推1 ~ 2个小版本。所以咱们课程主要讲解Python3.7版本。



版本区别：性能不同，语法不同（细微差别），Hadoop、Hive
