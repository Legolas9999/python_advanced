...
if选择原理图：学编程除了会写代码还不行，还要回画图（流程图） =》 visio
...
> 锦上添花的代码，有它可以做开发，没有它也可以做开发。但是有了这样一些语句以后，咱们的Python代码可以变得更加简洁！
...
![image-20220102100257742](media/image-20220102100257742.png)
